...
class PatientCheckinForm(forms.Form):
    ...
    first_name.widget.attrs['onclick'] = ONCLICK_SPEAK
    first_name.widget.attrs['oninput'] = ONINPUT_SPEAK

    last_name = forms.CharField(label='Last Name', max_length=100)
    last_name.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    social_security_number.widget.attrs['onclick'] = ONCLICK_SPEAK
...
class DemographicsForm(forms.Form):
    ...
    doctor.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    middle_name.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    preferred_language.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    home_phone.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    cell_phone.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    emergency_contact_name.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    emergency_contact_phone.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    emergency_contact_relation.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    employer.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    employer_address.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    employer_city.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    employer_state.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    employer_zip_code.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    primary_care_physician.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    responsible_party_name.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    responsible_party_relation.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    responsible_party_phone.widget.attrs['onclick'] = ONCLICK_SPEAK
    ...
    responsible_party_email.widget.attrs['onclick'] = ONCLICK_SPEAK
